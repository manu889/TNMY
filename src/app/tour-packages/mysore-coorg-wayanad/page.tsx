...
export const metadata: Metadata = {
  title: "Mysore Coorg Wayanad Tour Package | Multi Day Trip",
  description: "Multi day tour package covering Mysore, Coorg and Wayanad. Request itinerary and pricing on WhatsApp.",
...
export default function MysoreCoorgWayanadPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <Breadcrumbs items={[{ label: "Mysore Coorg Wayanad", href: ROUTES.MYSORE_COORG_WAYANAD }]} />
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900">Mysore – Coorg – Wayanad</h1>
        <p className="mt-4 text-lg text-slate-700 max-w-3xl">A popular multi-day itinerary combining hills, forests and sightseeing.</p>
