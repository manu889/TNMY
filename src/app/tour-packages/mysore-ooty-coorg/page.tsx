...
export const metadata: Metadata = {
  title: "Mysore Ooty Coorg Tour Package | Multi Day Trip",
  description: "Multi day tour package covering Mysore, Ooty and Coorg. Request itinerary and pricing on WhatsApp.",
...
export default function MysoreOotyCoorgPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <Breadcrumbs items={[{ label: "Mysore Ooty Coorg", href: ROUTES.MYSORE_OOTY_COORG }]} />
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900">Mysore – Ooty – Coorg</h1>
        <p className="mt-4 text-lg text-slate-700 max-w-3xl">A scenic multi-day hill station itinerary with flexible routing.</p>
